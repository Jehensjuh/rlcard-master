...
from rlcard.games.nolimitholdemwithodds import Game
from rlcard.games.nolimitholdemwithodds.round import Action
...
class NolimitholdemEnv(Env):
    ...
    def get_payoffs(self):
        ...
        '''
        # return np.array(self.game.rational_reward())
