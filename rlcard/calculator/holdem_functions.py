...
class Card:
    ...
    def __init__(self, card_string):
        self.suit, value = card_string[0], card_string[1]  # Extract suit and value correctly
        self.value = suit_value_dict[value]  # Use value to look up the numeric value in the dictionary
