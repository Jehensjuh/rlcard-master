...
def save_to_file(trajectories, player_wins):
    ...
    filename ="gameoutputs/"+ current_datetime.strftime("%Y%m%d_%H%M%S") + ".txt"
...
def play_game():
    ...
    agent = torch.load('C:/Users/jensv/OneDrive/Bureaublad/MasterProject/rlcard-master//examples/experiments/no-limit-holdem-aggressive_dqn_results/20240322_111905/model.pth')
