...
modelpath = 'C:/Users/jensv/OneDrive/Bureaublad/MasterProject/rlcard-master//examples/experiments/no-limit-holdem-defensive_dqn_results/20240329_113130'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--env',
        type=str,
        default='no-limit-holdem-defensive',
        choices=[
            'no-limit-holdem-defensive',
        ],
    )
    parser.add_argument(
        '--algorithm',
