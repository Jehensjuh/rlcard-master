...
# Load the JSON file
with open('TournamentData.json', 'r') as json_file:
...
plt.bar(index, player1_all_in_counts.values(), bar_width, label='Aggressive Agent')
plt.bar(index + bar_width, player2_all_in_counts.values(), bar_width, label='Rational Agent')
