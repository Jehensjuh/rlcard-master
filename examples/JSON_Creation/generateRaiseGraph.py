...
with open('C:/Users/jensv/OneDrive/Bureaublad/MasterProject/rlcard-master/examples/JSON_Creation/GameData.json', 'r') as json_file:
...
plt.plot(range(1, len(player1_raise_counts) + 1), player1_raise_counts, label='Player 1')
plt.plot(range(1, len(player2_raise_counts) + 1), player2_raise_counts, label='Player 2')
